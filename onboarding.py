...
def show_onboarding(data_dir: Path, detect_fn, history_html: Path):
    ...
    def show_welcome():
        clear()
        tk.Label(content, text="👁", font=("Helvetica", 48),
    ...
    def show_setup():
        ...
        items = [
            ("✓", "#44cc77", "Watching Documents, Desktop, Downloads"),
            ("✓", "#44cc77", "Clipboard monitoring active"),
            ("✓", "#44cc77", "Screen monitoring active"),
            ("✓", "#44cc77", "System tray icon running"),
            ("✓", "#44cc77", "14-day free trial started"),
        ]
